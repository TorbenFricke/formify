from formify.layout import ConditionalLayout, SidebarLight, Row
from PySide2 import QtWidgets
import typing

class SidebarContentView(QtWidgets.QWidget):
	def __init__(self, layouts: dict, value:str = None, sidebar_class=SidebarLight):
		QtWidgets.QWidget.__init__(self)
		self.content = ConditionalLayout(layouts, visible=value)
		self.content.layout().setMargin(8)
		self.sidebar = sidebar_class(layouts.keys())
